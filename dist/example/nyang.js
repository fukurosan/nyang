...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.NYANG = factory());
  ...
  var ZoomHandler = /*#__PURE__*/function () {
    ...
    _createClass(ZoomHandler, [{
      ...
      value: function zoomToCoordinates(x, y, scale) {
        select(this.graphContainerElement).select("svg").transition().duration(Env.ZOOM_TIME).call(this.zoom.transform, identity$1.translate(x, y).scale(scale)).select("g").attr("transform", "translate(".concat(x, ",").concat(y, ")scale(").concat(scale, ")"));
      }
      /**
