...
String.prototype.width = function (textStyle) {
  ...
  const d = d3.select("body").append("div").attr("class", textStyle).attr("style", "position: absolute;float: left;white-space: nowrap;visibility: hidden;").attr("id", "width-test") // tag this element to identify it
  .text(this),
