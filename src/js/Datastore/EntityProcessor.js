...
export default class EntityProcessor {
    constructor(eventEmitter, styles, userDefinedOptions) {
        ...
        this.enableFixedEdgeLabelWidth = userDefinedOptions.enableFixedEdgeLabelWidth !== undefined ? userDefinedOptions.enableFixedEdgeLabelWidth : Env.FIXED_EDGE_LABEL_WIDTH
