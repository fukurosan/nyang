...
export default class Engine {
    constructor(forceCenterX, forceCenterY, eventEmitter) {
        ...
        this.ee.on(EventEnum.CLICK_ENTITY, () => this.stop())
        ...
        this.ee.on(EventEnum.ENGINE_LAYOUT_RESET_REQUESTED, (nodes, edges) => this.resetLayout(nodes, edges))
        this.ee.on(EventEnum.NODE_FIXATION_REQUESTED, (node, x, y) => {
            this.alpha(1)
            this.restart()
        })
        this.ee.on(EventEnum.TOGGLE_MULTIPLICITY_REQUESTED, () => this.restart())
